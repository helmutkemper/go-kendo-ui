...
type KendoUiAutoComplete struct {
	...
	*/
	...
	//   </script>
	//
	Animation interface{} `jsObject:"animation" jsType:"*KendoAnimation,Boolean" jsonSchema_description:"https://docs.telerik.com/kendo-ui/api/javascript/ui/autocomplete\n\nDefault: \nType: Boolean, Object\n\nDescription: Configures the opening and closing animations of the suggestion popup. Setting the <code>animation</code> option to <code>false</code> will disable the opening and closing animations. As a result the suggestion popup will open and close instantly.\n\n<code>animation:true</code> is not a valid configuration.\n\nExample - disable open and close animations\n\n<input id=\"autocomplete\" />\n<script>\n$(\"#autocomplete\").kendoAutoComplete({\n  animation: false\n});\n</script>\n\nExample - configure the animation\n\n<input id=\"autocomplete\" />\n<script>\n$(\"#autocomplete\").kendoAutoComplete({\n  animation: {\n   close: {\n     effects: \"fadeOut zoom:out\",\n     duration: 300\n   },\n   open: {\n     effects: \"fadeIn zoom:in\",\n     duration: 300\n   }\n  }\n});\n</script>\n"`
