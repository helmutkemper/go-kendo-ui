...
type HtmlInputTime struct {
	...
	*/
	Step int `htmlAttr:"step" description:"Works with the min and max attributes to limit the increments at which a numeric or date-time value can be set. It can be the string any or a positive floating point number. If this attribute is not set to any, the control accepts only values at multiples of the step value greater than the minimum."`

	ValueAsDate Boolean `htmlAttr:"valueasdate" description:""`

	ValueAsNumber Boolean `htmlAttr:"valueasnumber" description:""`
